...
public class HoughPanel extends JPanel
{
	...
	public int[][] generateHough(int[][] grayEdges)
	{
	    ...
	    // temp code:
	    houghArray[grayEdges.length/2][grayEdges[0].length/2] += 1; // one sample upvote at the center of the image. Remove this line in your program.
	    // ----------------------------
		return houghArray;
	}
	...
	public ArrayList<Circle> findBestCircles(int [][] houghArray)
	{
		...
		int votesThreshold = 60; // the minimum number of votes required to count as a "found" circle. (adjust this)
	...
	public int[][] normalizeArrayTo255(int[][] unnormalized)
	{
		...
		//TODO: Find the maximum value in the array.
			...
			max = 1;// delete this when you write the correct version..
